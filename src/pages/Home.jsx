...
export default function Home() {
  ...
  return (
    <div>
      <section className="elevate" style={{ background: 'linear-gradient(135deg, #eaf2ff, #ffffff)', border: '1px solid #e5e7eb', borderRadius: 16, padding: 28, display: 'flex', gap: 28, alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap' }}>
